...
class AMI430Vector:
    ...
    def ramp_spherical(self, field=0, thetaDeg=0, phiDeg=0, ramp_rate=0.5):
        """
        ...
        """
        theta = float(thetaDeg * np.pi / 180)  #
        phi = float(phiDeg * np.pi / 180)  #
        self._theta = theta
        self._phi = phi
...
if __name__ == "__main__":
    ...
    magnet.ramp_spherical(field=165.65, thetaDeg=0, phiDeg=0, ramp_rate=0.1)
