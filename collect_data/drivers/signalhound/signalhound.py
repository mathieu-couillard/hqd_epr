...
class SignalHoundSA:
    ...
    def hidedisplay(self, displayhide = '?'):
        ...
        if displayhide in options:
            self.logger.info('Display Setting Chenged to:'+ displayhide)
            return self._com(':DISP:HIDE{}'.format(options[displayhide]))
        else:
            self.logger.error('InvalidDisplaySettingException')
    ...
    def measurement_mode(self, mode = '?'):
        ...
        if mode in options:
            ...
            self.logger.error('InvalidMeasurementModeSelectionException')
    ...
    def init_continuous(self, init = '?'):
        ...
        if init in options:
            ...
            self.logger.error('InvalidContinuousInitiateMothodException')
            return Exception('InvalidContinuousInitiateMothodException')

    def init_now(self):
        self.logger.info('Single Measurement Triggered')
    ...
    def auto_raw_fft_BW(self, auto = '?'):
        ...
        if auto in options:
            ...
            self.logger.error('InvalidAutoSettingException')
    ...
    def video_fft_shape(self, type = '?'):
        ...
        if type in options:
            ...
            self.logger.error('InvalidFFTWindowTypeException')
    ...
    def trace_type(self, type = '?'):
        ...
        if type in options:
            ...
            self.logger.error('INvalidTraceTypeError')
    ...
    def data_type(self, type = '?'):
        ...
        if type in options:
            ...
            self.logger.error('InvalidDataTypeRequestException')
