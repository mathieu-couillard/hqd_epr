...
class AMI430:
    ...
    # @property
    # def ramp_rate_current(self, segment):
    #     return self._query("RAMP:RATE:CURR {}?".format(segment))

    # @ramp_rate_current.setter
    # def ramp_rate_current(self, segment, rate):
    #     if self.ramp_rate_units == '0':
    #         if rate > 0.107:
    #             return

    #         self._write('CONFigure:RAMP:RATE:CURR {} {}'.format(segment, rate))
