"""
A script to measure the analog signal when no drive is applied.
Allows you to correct for offsets
"""
...
with program() as input_cal:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        play("cryosw", "CryoSw")
        wait(600//4, "digitizer")
        reset_if_phase("digitizer")
        measure("readout", "digitizer", adc_stream=adc_st)
        wait(1000//4, "digitizer")
...
qmm = QuantumMachinesManager(host=qm_config.HOST_IP)
